...
def generate_launch_description():
    ...
    default_model_path = os.path.join(pkg_share, 'description/config/motor_drive_webots_urdf.urdf')
    ...
    mappings = [('/diff_drive_controller/cmd_vel_unstamped', '/cmd_vel'), ('/diff_drive_controller/odom', '/odom')]
    ros2_control_params = os.path.join(pkg_share, 'config', 'controllers_webots.yaml')
    robot_description_path = os.path.join(pkg_share, 'description/config', 'motor_drive_webots_urdf.urdf')
    ...
    nav2_params = os.path.join(pkg_share, 'config', nav2_params_file)
    nav2_map = os.path.join(pkg_share, 'config', 'map.yaml')
